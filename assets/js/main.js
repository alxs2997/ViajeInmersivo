...
/*==================== TYPE AND CHANGE TEXT ====================*/

var typed = new Typed('.typed', {
	strings: [
        '<i class="places">Pueblos.</i>',
        '<i class="places">Playas.</i>',
		'<i class="places">Volcanes.</i>',
		'<i class="places">Lagos.</i>',
        '<i class="places">Paisajes.</i>',
	],
	...
	backSpeed: 77, // Velocidad en milisegundos para borrrar una letra,
